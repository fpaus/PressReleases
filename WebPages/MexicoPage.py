...
class MexicoPage(GenericPage):
    def __init__(self):
        ...
        self._url = 'https://www.gob.mx/sre/es/archivo/prensa?category=Comunicados&filter_id=&filter_origin=archive&idiom=es&order=DESC&page={}&style=th&tags=&utf8=%E2%9C%93&year='
